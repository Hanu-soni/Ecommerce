...
function UserInvoicePage() {
    ...
    return (
        ...
        //   </div>
        <div className=''>
            <div className="my-8 py-4 mx-4 font-poppins text-[20px] font-medium leading-[21px] text-[#011F4B]">
                Details
            </div>
                ...
                <div className="h-full rounded  shadow-lg mx-4 p-1">
                    <div className="mx-4 flex flex-col md:flex-row justify-between p-5 bg-white  font-poppins text-black max-w-5xl mx-auto">
                        <div className="flex-1">
                            ...
                            <div className="mb-4">
                                <p className='flex gap-20 font-poppins text-[14px] font-normal leading-[21px] text-left text-[#000000]'><span className="font-poppins text-[14px] font-normal leading-[21px] text-left text-[#6B6B6B]">Vendor ID:</span> 
                               {invoice?.seller?.sellerId}</p>

                                <p className='flex gap-20 font-poppins text-[14px] font-normal leading-[21px] text-left text-[#000000]'><span className="font-poppins text-[14px] font-normal leading-[21px] text-left text-[#6B6B6B]">Vendor Name:</span>
                                {invoice?.seller?.storeName}
                              </p>
                                <p className='flex gap-20 font-poppins text-[14px] font-normal leading-[21px] text-left text-[#000000]'><span className="font-poppins text-[14px] font-normal leading-[21px] text-left text-[#6B6B6B]">Address:</span>
                                {invoice?.seller?.address}
                             </p>
                            </div>
                            <div className="mt-4">
                                <p className="font-poppins text-[12px] font-semibold leading-[21px] text-left">Bill To</p>
                                <p className='font-poppins text-[14px] font-normal leading-[21px] text-left text-[#000000]'><span class="font-poppins text-[14px] font-normal leading-[21px] text-left text-[#6B6B6B]">Name:</span>
                                {invoice?.user?.name}</p>
                                <p className='font-poppins text-[14px] font-normal leading-[21px] text-left text-[#000000]'><span className="font-poppins text-[14px] font-normal leading-[21px] text-left text-[#6B6B6B]">Email:</span></p>
                            </div>
                        </div>
                        <div className="flex-1 mt-6 md:mt-0 md:pl-10 border-t md:border-t-0 md:border-l border-gray-300">
                            <div className="mb-4">
                                <p className='font-poppins text-[14px] font-normal leading-[21px] text-left text-[#000000]'>
                                    <span className="font-poppins text-[14px] font-normal leading-[21px] text-left text-[#6B6B6B]">Invoice Number:</span> {invoice?.invoiceNumber} </p>
                                <p className='font-poppins text-[14px] font-normal leading-[21px] text-left text-[#000000]'><span className="font-poppins text-[14px] font-normal leading-[21px] text-left text-[#6B6B6B]">Issued:</span>
                                {invoice?.order?.orderDate}</p>
                             
                            </div>

                            <div className="mt-4">
                                <p className="font-poppins text-[12px] font-semibold leading-[21px] text-left">Order Summary</p>
                                <p className='font-poppins text-[14px] font-normal leading-[21px] text-left text-[#000000]'><span class="font-poppins text-[14px] font-normal leading-[21px] text-left text-[#6B6B6B]">Order ID:</span>
                                {invoice?.order?.orderId}</p>
