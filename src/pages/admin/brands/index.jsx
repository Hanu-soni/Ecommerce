    ...
    <>
      <div className="mx-auto my-8 px-6">
        ...
        <div className="flex justify-between mb-3">
          <h2 className="text-2xl font-bold mb-4">Brands List</h2>
          <Link
              ...
              <tbody>
                {brands.map((item, key) => (
                  <tr key={key} className="mb-2">
                    <td className="border-b border-[#eee] dark:border-strokedark pl-11">
                    ...
                    <td className="border-b border-[#eee] dark:border-strokedark">
                      <div className="flex items-center space-x-3.5">
                        <button
                          ...
                          onClick={() =>
                            navigate(`/seller/brands/edit/${item?.brandId}`)
                          }
                        >
                          <FiEdit />
                        </button>
